...
export const api = {
  ...
  getCollectorIntegrity: (days = 30) => request(`/collections/collector-integrity?days=${days}`),
  ...
  listSavingsGLMappings: () => request("/savings/gl-mappings"),
  setSavingsGLMapping: (purpose: string, glAccountId: string) => request("/savings/gl-mappings", { method: "POST", body: JSON.stringify({ purpose, glAccountId }) }),
  listCashVaultGLMappings: () => request("/cash-vault/gl-mappings"),
  setCashVaultGLMapping: (purpose: string, glAccountId: string) => request("/cash-vault/gl-mappings", { method: "POST", body: JSON.stringify({ purpose, glAccountId }) }),
